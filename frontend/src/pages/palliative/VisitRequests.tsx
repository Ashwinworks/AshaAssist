            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
              ...
              <div>
                ...
                <select
                  ...
                  className="input"
                >
                  <option value="Medium">Medium - Regular visit needed</option>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  onBlur={handleBlur}
                  placeholder="Please describe the reason for the home visit (e.g., pain management, medication assistance, health monitoring, etc.)"
                  required
                  rows={4}

...
const Feedback: React.FC = () => {
  ...
  const submit = async () => {
    try {
      ...
      setSuccessMsg('Thank you for your valuable feedback! It helps us improve palliative care services.');
      setComments('');
  ...
  const getFeedbackMessage = () => {
    ...
    return "How was your experience with your care services?";
  };
      ...
      <div className="card" style={{ width: '100%' }}>
        ...
        <div className="card-header" style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <h2 className="card-title" style={{ margin: 0, color: '#5b21b6' }}>Rate Your Care Services</h2>
              <p style={{ margin: '0.25rem 0 0', color: '#7c3aed', fontSize: '0.9rem' }}>
                Your feedback helps improve palliative care services
              </p>
            </div>
          </div>
        </div>
          ...
          <div style={{ 
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center', 
                gap: '0.5rem',
                background: canSubmit ? 'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)' : '#cbd5e1',
                color: 'white',
                border: 'none', 
                padding: '0.75rem 1.5rem', 
                borderRadius: '0.5rem',
                ...
                fontWeight: 600,
                transition: 'all 0.2s ease',
                boxShadow: canSubmit ? '0 4px 6px rgba(139, 92, 246, 0.3)' : '0 1px 2px rgba(0,0,0,0.05)'
              }}
              onMouseEnter={(e) => {
                if (canSubmit) {
                  e.currentTarget.style.transform = 'translateY(-2px)';

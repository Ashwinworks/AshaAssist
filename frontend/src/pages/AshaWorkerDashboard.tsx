  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (urgentVisits.length > 0) {
        alerts.push({
          type: 'urgent',
          title: `${t('asha.urgent')}: ${urgentVisits.length} ${urgentVisits.length > 1 ? t('asha.urgentVisitsPlural') : t('asha.urgentVisits')}`,
          message: t('asha.highPriority'),
          color: 'red'
        });
      }
      if (scheduledToday.length > 0) {
        alerts.push({
          type: 'info',
          title: `${scheduledToday.length} ${scheduledToday.length > 1 ? t('asha.visitsScheduledPlural') : t('asha.visitScheduled')}`,
          message: t('asha.checkCalendar'),
          color: 'blue'
        });
      }
      if (pendingSupplies.length > 0) {
        alerts.push({
          type: 'warning',
          title: `${pendingSupplies.length} ${pendingSupplies.length > 1 ? t('asha.suppliesNeedScheduling') : t('asha.supplyNeedScheduling')}`,
          message: t('asha.approvedSupplies'),
          color: 'yellow'
        });
      }
      ...
      <div>
        ...
        <div className="card" style={{
          ...
          <div className="card-header">
            <h2 className="card-title" style={{ color: '#0369a1' }}>{t('asha.goodDay')}</h2>
          </div>
              ...
              >
                <div className="card-content" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#0369a1', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.pendingVisitRequests')}</p>
                  </div>
                </div>
                {stats.urgentVisitRequests > 0 && (
                  <div style={{
                    ...
                    {stats.urgentVisitRequests} {t('asha.urgent')}
                  </div>
                )}
              </div>
              ...
              >
                <div className="card-content" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#047857', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.users')}</p>
                  </div>
                </div>
                <div style={{
                  marginTop: '0.75rem',
                  ...
                  {stats.maternalUsers} {t('asha.maternal')}, {stats.palliativeUsers} {t('asha.palliative')}
                </div>
              </div>
              ...
              >
                <div className="card-content" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#6d28d9', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.visitsToday')}</p>
                  </div>
                </div>
                <div style={{
                  marginTop: '0.75rem',
              ...
              >
                <div className="card-content" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#d97706', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.supplyRequestsLabel')}</p>
                  </div>
                </div>
                <div style={{
                  marginTop: '0.75rem',
                  ...
                  {stats.pendingSupplyRequests} {t('asha.toSchedule')}
                </div>
              </div>
            </div>
              ...
              <div className="card-content">
                <div style={{
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, color: '#374151' }}>{t('asha.visitRequests')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, color: '#374151' }}>{t('asha.homeVisits')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, color: '#374151' }}>{t('asha.supplyRequests')}</span>
                  </button>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, color: '#374151' }}>{t('asha.healthRecords')}</span>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="card-content">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
                  <div style={{
                    ...
                    <p style={{ color: '#0369a1', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.totalVisitsMonth')}</p>
                  </div>
                  ...
                  <div style={{
                    ...
                    <p style={{ color: '#047857', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.maternalUsers')}</p>
                  </div>
                  ...
                  <div style={{
                    ...
                    <p style={{ color: '#6d28d9', margin: 0, fontSize: '0.875rem', fontWeight: 500 }}>{t('asha.palliativeUsers')}</p>
                  </div>
                </div>
              </div>
            </div>

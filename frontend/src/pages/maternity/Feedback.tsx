    ...
    <MaternityLayout title="Feedback About ASHA">
      <div className="card" style={{ width: '100%' }}>
        <div className="card-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <h2 className="card-title" style={{ margin: 0 }}>Rate Your ASHA Worker</h2>
        </div>
        <div className="card-content" style={{ display: 'grid', gap: '1.25rem' }}>
          <p style={{ color: 'var(--gray-600)', margin: 0 }}>
            Share your experience. This helps improve maternal care services. Colors use our app theme (no pink here).
          </p>
